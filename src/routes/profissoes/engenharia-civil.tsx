...
export const Route = createFileRoute('/profissoes/engenharia-civil')({
  component: EngenhariaCivilPage,
})

function EngenhariaCivilPage() {
  const profession = professions.find(
    (item) => item.slug === 'engenharia-civil'
  )
